...
```json
"features": {
    "ghcr.io/JoftheV/features-Dev-Containers-/java:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/JoftheV/features-Dev-Containers-/blob/main/src/java/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
